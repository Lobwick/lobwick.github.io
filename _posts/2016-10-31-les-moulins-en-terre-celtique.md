...
<em>Cela fait deux mois que nous avons laissé Félix à Dublin et il nous manque déjà.</em>
...
[gallery type="rectangular" size="medium" ids="3046,3047,3045,3048,3049"]
...
<em>Pas évident de passer tous les contrôles, qui sont quand même rassurants, en plus des nombreux militaires vigilants.</em>
...
<em>D'ailleurs, il nous avait laissés sur le port en août de la même manière lors de son <a href="http://twomoulins.fr/vie/felix-a-dublin" target="_blank">installation à Dublin</a>.</em>
...
<em>A sa descente, le dépaysement est complet, avec le petit port pour nous accueillir.</em>

[gallery type="rectangular" size="large" columns="2" link="file" ids="3229,3228,3227,3226"]
...
[gallery size="large" link="file" columns="2" type="rectangular" ids="3231,3232,3233,3230"]
...
<em>Le quartier du parlement irlandais  ( Leinster House ) est suffisant pour l'après-midi.</em>

Il est en effet entouré de la National Gallery, du Natural History Museum, de la National Library et du National Museum.

[gallery size="large" columns="2" link="file" type="rectangular" ids="3246,3239,3243,3244,3241,3080,3245,3240"]
...
<em>Mais, à mi-parcours, la récompense se présente à nous, au fond d'une vallée elfique digne du "Seigneur des Anneaux"</em>
...
<em>C'est un parcours urbain mais vallonné qui s'effectue à pleine vitesse.</em>

Ce tour commence par la découverte du Phoenix Park, l'un des plus grands parcs européens, où réside leur président.

[gallery size="large" link="file" columns="2" type="rectangular" ids="3263,3264,3266,3092,3267"]
...
<em>Tenue hivernale exigée car le bus est cabriolé et de l'air frais ventile la capitale.</em>
...
<em>C'est là que Félix, toujours sur son deux roues, nous rejoint après ses cours car nous ne sommes séparés qu'une dizaine de kilomètres.</em>

Destination populaire pour les vacances, depuis l'époque victorienne, c'est une élégante ville portuaire.

[gallery size="large" columns="2" link="file" type="rectangular" ids="3128,3300,3297,3298"]
...
<em>Nous ne pouvions repartir sans visiter l'incontournable musée de la fameuse bière Guinness !</em>
...
[gallery size="medium" link="file" columns="2" type="rectangular" ids="3390,3335,3393,3391,3386,3394"]

D'étage en étage, les explications sont très fournies mais le secret de fabrication, comme un certain Coca, est bien gardé.

[gallery link="none" columns="2" type="rectangular" size="medium" ids="3336,3343,3364,3342,3338,3325,3320"]

Comme il est bien connu que la chaleur se fait sentir en montant, il est temps d'en savourer une bonne pinte.

[gallery link="none" columns="2" type="rectangular" size="medium" ids="3158,3376,3374,3373,3385,3380,3372,3371,3377"]

Tout est prévu et compris dans le billet d'entrée, en arrivant dans le bar panoramique, au sommet de la tour.

<em>A consommer avec modération bien entendu, pour savourer le coup d'oeil à 360 degrés sur Dublin et les environs.</em>
...
[gallery size="medium" link="file" columns="2" type="rectangular" ids="3050,3305,3304,3302,3303"]
...
<p style="padding-left: 30px;"><em>Dans deux mois, Félix profitera de ses congés pour nous retrouver à la maison.</em>
